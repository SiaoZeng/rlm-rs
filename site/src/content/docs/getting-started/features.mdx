...
> **Note:** Version 2.24.0+ is excluded due to Windows compilation issues. See [Troubleshooting](/troubleshooting/troubleshooting/#usearch-version-issues) for details.
